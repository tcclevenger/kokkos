...
struct TestTeamThreadMDRangeParallelFor : public TestTeamMDParallelFor {
  ...
  static void test_parallel_for_3D_TeamThreadMDRange(DimsType const& dims) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamRange = Kokkos::TeamThreadMDRange(team, n0, n1);
  ...
  static void test_parallel_for_4D_TeamThreadMDRange(DimsType const& dims) {
    ...
    int n1                            = dims[2];
    int n2                            = dims[3];
    Kokkos::Array<int, 3> upperBounds = {n0, n1, n2};

    // For 4D, use lower bound constructors
    int s0                            = 1;
    int s1                            = 1;
    int s2                            = 1;
    Kokkos::Array<int, 3> lowerBounds = {s0, s1, s2};
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamRange =
              Kokkos::TeamThreadMDRange(team, lowerBounds, upperBounds);
  ...
  static void test_parallel_for_5D_TeamThreadMDRange(DimsType const& dims) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamRange = Kokkos::TeamThreadMDRange(team, n0, n1, n2, n3);
  ...
  static void test_parallel_for_6D_TeamThreadMDRange(DimsType const& dims) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamRange = Kokkos::TeamThreadMDRange(team, n0, n1, n2, n3, n4);
  ...
  static void test_parallel_for_7D_TeamThreadMDRange(DimsType const& dims) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamRange =
              Kokkos::TeamThreadMDRange(team, n0, n1, n2, n3, n4, n5);
  ...
  static void test_parallel_for_8D_TeamThreadMDRange(DimsType const& dims) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamRange =
              Kokkos::TeamThreadMDRange(team, n0, n1, n2, n3, n4, n5, n6);
  ...
  static void test_parallel_single_direction_test(DimsType const& dims) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          auto teamRange = Kokkos::TeamThreadMDRange(team, n0, n1, n2);
...
struct TestThreadVectorMDRangeParallelFor : public TestTeamMDParallelFor {
  ...
  static void test_parallel_for_4D_ThreadVectorMDRange(DimsType const& dims) {
    ...
    int n1                            = dims[2];
    int n2                            = dims[3];
    Kokkos::Array<int, 2> upperBounds = {n1, n2};

    // For 4D, use lower bound constructors
    int s1                            = 1;
    int s2                            = 1;
    Kokkos::Array<int, 2> lowerBounds = {s1, s2};
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamRange =
              Kokkos::ThreadVectorMDRange(team, lowerBounds, upperBounds);
  ...
  static void test_parallel_for_5D_ThreadVectorMDRange(DimsType const& dims) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamThreadRange = Kokkos::TeamThreadRange(team, n0);
          auto teamRange       = Kokkos::ThreadVectorMDRange(team, n1, n2, n3);
  ...
  static void test_parallel_for_6D_ThreadVectorMDRange(DimsType const& dims) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamThreadRange = Kokkos::TeamThreadRange(team, n0);
          auto teamRange = Kokkos::ThreadVectorMDRange(team, n1, n2, n3, n4);
  ...
  static void test_parallel_for_7D_ThreadVectorMDRange(DimsType const& dims) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamThreadRange = Kokkos::TeamThreadRange(team, n0);
          auto teamRange =
              Kokkos::ThreadVectorMDRange(team, n1, n2, n3, n4, n5);
  ...
  static void test_parallel_for_8D_ThreadVectorMDRange(DimsType const& dims) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamThreadRange = Kokkos::TeamThreadRange(team, n0);
          auto teamRange =
              Kokkos::ThreadVectorMDRange(team, n1, n2, n3, n4, n5, n6);
  ...
  static void test_parallel_for_3D_TeamVectorMDRange(DimsType const& dims) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamRange = Kokkos::TeamVectorMDRange(team, n0, n1);
  ...
  static void test_parallel_for_4D_TeamVectorMDRange(DimsType const& dims) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamRange =
              Kokkos::TeamVectorMDRange(team, lowerBounds, upperBounds);
  ...
  static void test_parallel_for_5D_TeamVectorMDRange(DimsType const& dims) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamRange = Kokkos::TeamVectorMDRange(team, n0, n1, n2, n3);
  ...
  static void test_parallel_for_6D_TeamVectorMDRange(DimsType const& dims) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamRange = Kokkos::TeamVectorMDRange(team, n0, n1, n2, n3, n4);
  ...
  static void test_parallel_for_7D_TeamVectorMDRange(DimsType const& dims) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamRange =
              Kokkos::TeamVectorMDRange(team, n0, n1, n2, n3, n4, n5);
  ...
  static void test_parallel_for_8D_TeamVectorMDRange(DimsType const& dims) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const TeamType& team) {
          ...
          auto teamRange =
              Kokkos::TeamVectorMDRange(team, n0, n1, n2, n3, n4, n5, n6);
...
struct TestTeamThreadMDRangeParallelReduce : public TestTeamMDParallelReduce {
  ...
  static void test_parallel_reduce_for_3D_TeamThreadMDRange(
    ...
    Kokkos::parallel_reduce(
        ...
        KOKKOS_LAMBDA(TeamType const& team, DataType& leagueSum) {
          ...
          Kokkos::parallel_reduce(
              Kokkos::TeamThreadMDRange(team, n0, n1),
  ...
  static void test_parallel_reduce_for_4D_TeamThreadMDRange(
    ...
    int n1                            = dims[2];
    int n2                            = dims[3];
    Kokkos::Array<int, 4> upperBounds = {leagueSize, n0, n1, n2};

    // For 4D, use lower bound constructors
    int s0                            = 1;
    int s1                            = 1;
    int s2                            = 1;
    Kokkos::Array<int, 4> lowerBounds = {0, s0, s1, s2};
    ...
    Kokkos::parallel_reduce(
        ...
        KOKKOS_LAMBDA(TeamType const& team, DataType& leagueSum) {
          ...
          Kokkos::parallel_reduce(
              Kokkos::TeamThreadMDRange(team, {s0, s1, s2}, {n0, n1, n2}),
  ...
  static void test_parallel_reduce_for_5D_TeamThreadMDRange(
    ...
    Kokkos::parallel_reduce(
        ...
        KOKKOS_LAMBDA(TeamType const& team, DataType& leagueSum) {
          ...
          Kokkos::parallel_reduce(
              Kokkos::TeamThreadMDRange(team, n0, n1, n2, n3),
  ...
  static void test_parallel_reduce_for_6D_TeamThreadMDRange(
    ...
    Kokkos::parallel_reduce(
        ...
        KOKKOS_LAMBDA(TeamType const& team, DataType& leagueSum) {
          ...
          Kokkos::parallel_reduce(
              Kokkos::TeamThreadMDRange(team, n0, n1, n2, n3, n4),
              [=](const int& i, const int& j, const int& k, const int& l,
...
struct TestThreadVectorMDRangeParallelReduce : public TestTeamMDParallelReduce {
  ...
  static void test_parallel_reduce_for_4D_ThreadVectorMDRange(
    ...
    int s1                            = 1;
    int s2                            = 1;
    Kokkos::Array<int, 4> lowerBounds = {0, 0, s1, s2};
    ...
    Kokkos::parallel_reduce(
        ...
        KOKKOS_LAMBDA(TeamType const& team, DataType& leagueSum) {
          ...
          auto threadVectorRange =
              Kokkos::ThreadVectorMDRange(team, {s1, s2}, {n1, n2});
  ...
  static void test_parallel_reduce_for_5D_ThreadVectorMDRange(
    ...
    Kokkos::parallel_reduce(
        ...
        KOKKOS_LAMBDA(TeamType const& team, DataType& leagueSum) {
          ...
          auto teamThreadRange = Kokkos::TeamThreadRange(team, n0);
          auto threadVectorRange =
              Kokkos::ThreadVectorMDRange(team, n1, n2, n3);
  ...
  static void test_parallel_reduce_for_6D_ThreadVectorMDRange(
    ...
    Kokkos::parallel_reduce(
        ...
        KOKKOS_LAMBDA(TeamType const& team, DataType& leagueSum) {
          ...
          auto teamThreadRange = Kokkos::TeamThreadRange(team, n0);
          auto threadVectorRange =
              Kokkos::ThreadVectorMDRange(team, n1, n2, n3, n4);
    ...
    Kokkos::parallel_reduce(
        ...
        KOKKOS_LAMBDA(TeamType const& team, DataType& leagueSum) {
          ...
          auto teamVectorRange =
              Kokkos::TeamVectorMDRange(team, {s0, s1, s2}, {n0, n1, n2});
  ...
  static void test_parallel_reduce_for_5D_TeamVectorMDRange(
    ...
    Kokkos::parallel_reduce(
        ...
        KOKKOS_LAMBDA(TeamType const& team, DataType& leagueSum) {
          ...
          auto teamVectorRange =
              Kokkos::TeamVectorMDRange(team, n0, n1, n2, n3);
  ...
  static void test_parallel_reduce_for_6D_TeamVectorMDRange(
    ...
    Kokkos::parallel_reduce(
        ...
        KOKKOS_LAMBDA(TeamType const& team, DataType& leagueSum) {
          ...
          auto teamVectorRange =
              Kokkos::TeamVectorMDRange(team, n0, n1, n2, n3, n4);
